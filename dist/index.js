...
try {
    ...
    (0, index_1.run)(o, (msg) => core.info(msg));
}
catch (error) {
...
class SandboxAPIProcessor {
    ...
    getAppGUIDbyNameAPI(appName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //send request
            try {
                const applicationsListResponse = yield axios_1.default.get(`https://${(0, auth_1.getHost)()}${path}`, {
                    headers: {
                        'Authorization': (0, auth_1.generateHeader)(path, 'GET', this.apiKey, this.apiSecret),
                    },
                });
...
const generateHeader = (url, method, id, key) => {
